...
%output: Processed signal: EMG_CARROT_SUBxx (contain 10 cell for 10 bites),
%EMG_APPLE_Subxx (contain 10 cell for 10 bites), EMG_BANANA_Subxx (contain 10 cell for 10 bites)

clc;clear all;close all;
f=cell2mat(struct2cell(load ('EMG_SUB01.mat')));
ts = (0:numel(f)-1)/1000;
figure;
plot(ts,f);
title('EMG Response');
...
%%
[XNorm, mu, stddev] = featureNormalize(f); %normalize
...
save('emg_apple_sub01.mat','A') %change filename
