...
% For each participant: pressure_apple_subx, pressure_banana_subx, pressure_carrot_sub
...
for ii = 1:15 % subjects processed data input file
 A=importdata (['pressure_apple_sub' num2str(ii) '.mat']); %file contains pressure and pushbutton_data
  B=importdata (['pressure_banana_sub' num2str(ii) '.mat']); %file contains pressure and pushbutton_data
   C=importdata (['pressure_carrot_sub' num2str(ii) '.mat']); %file contains pressure and pushbutton_data
...
title('Box plot of Pressure data')
